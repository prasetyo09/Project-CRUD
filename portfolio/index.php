				...
				<div class="slider-item ">
					...
					<div class="container">
						<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
							<div class="one-third js-fullheight order-md-last img" style="background-image:url(project-crud/assets/img/<?php echo $v['image'] ?>); width: 800px; height: 800px;">
								<div class="overlay"></div>
							</div>
				...
				?>
					<div class="col-md-6 animate-box">
						<div class="progress-wrap ftco-animate">
							<h3 <?php echo $v['progress'] <= 10 ? '33px' : '5px' ?> ;"><?php echo htmlspecialchars($v['name']); ?></h3>
							<div class="progress">
