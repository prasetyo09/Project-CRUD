                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="app.php?page=create-user&edit=<?php echo $row['id']?>" class="btn btn-success btn-sm">Edit</a>
                                    <a onclick="return confirm('Are you sure want to delete this data?')" href="app.php?page=user&delete=<?php echo $row['id']?>" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
